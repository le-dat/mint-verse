...
import { ListingFormData, NFT } from "@/types";
        ...
        <div className="aspect-square relative">
          ...
          <div className="absolute top-2 right-2 flex gap-2">
            <Button
              variant="secondary"
              size="icon"
              className={cn("bg-background/50 backdrop-blur-sm", liked && "text-red-500")}
              onClick={(e) => {
                e.stopPropagation();
                setLiked(!liked);
              }}
          ...
          {nft.listed && (
            <Badge className="absolute top-2 left-2 bg-primary">Listed on OpenSea</Badge>
          )}
        </div>
        <div className="p-4">
