...
import { Collection, ListingFormData, NFT } from '@/types';
    ...
    nfts: [
      {
        ...
        name: 'Cyber Punk #1',
        description:
          'A futuristic character with glowing eyes and neon lights.',
        imageUrl:
          'https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=800&auto=format&fit=crop&q=60',
        createdAt: new Date(),
        price: 1.2,
      ...
      },
      {
        ...
        name: 'Cyber Punk #2',
        description:
          'A cybernetic character with a robotic arm and glowing implants.',
        imageUrl:
          'https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=800&auto=format&fit=crop&q=60',
        createdAt: new Date(),
        price: 2.3,
...
export function CollectionContainer({
  ...
  if (uncategorizedNFTs.length > 0) {
    collections.push({
      ...
      totalValue: uncategorizedNFTs.reduce(
  ...
  return (
    <Card className='h-full backdrop-blur-sm bg-white/30 dark:bg-transparent border-muted overflow-auto'>
      {selectedCollection ? (
        <CollectionView
